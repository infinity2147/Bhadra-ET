...
| **Architecture diagram** | [`docs/architecture.html`](docs/architecture.html) — standalone, prints to one page |
| **Design decisions** (grounded) | [`docs/decisions.md`](docs/decisions.md) — every stack choice tied to research/constraints |
| **Corpus design** | [`docs/corpus-design.md`](docs/corpus-design.md) |
| **Full system handoff** (detailed) | [`docs/HANDOFF.md`](docs/HANDOFF.md) + [`docs/HANDOFF-2.md`](docs/HANDOFF-2.md) |
