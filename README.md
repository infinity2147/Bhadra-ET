...
Diagram: [`docs/ARCHITECTURE.md`](smriti/docs/ARCHITECTURE.md) (PDF: `docs/architecture.pdf`).
Full technical write-up: [`docs/OVERVIEW.md`](smriti/docs/OVERVIEW.md) (PDF: `docs/OVERVIEW.pdf`).
...
- [`docs/OVERVIEW.md`](smriti/docs/OVERVIEW.md) — full technical overview (PDF: `docs/OVERVIEW.pdf`)
- [`docs/ARCHITECTURE.md`](smriti/docs/ARCHITECTURE.md) — system architecture (PDF: `docs/architecture.pdf`)
- [`docs/decisions.md`](smriti/docs/decisions.md) — engineering decisions and their rationale
- [`docs/corpus-design.md`](smriti/docs/corpus-design.md) — the reference dataset
...
[`docs/decisions.md`](smriti/docs/decisions.md).
